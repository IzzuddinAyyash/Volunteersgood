    ...
    <nav className={`fixed w-full z-10 ${isScrolled ? ' bg-[#0A65CC]' : 'bg-[#0A65CC]'}`}>
      <div className="container mx-auto px-4 py-4 flex justify-between items-center h-full">
          ...
          <div className="relative">
            ...
            >
              <div className="absolute mt-2 w-48 bg-white rounded-md shadow-lg z-20">
                ...
                <Link to="/Lprelawan" className="block px-4 py-2 text-gray-800 hover:bg-gray-200">Cari Organisasi</Link>
        ...
        <div className="hidden md:flex space-x-2">
          <Link to="/Daftar" className="text-white border border-white px-4 py-2 ml-[-10px] rounded-full hover:bg-white hover:text-black transition font-thin">
            Daftar
          </Link>
